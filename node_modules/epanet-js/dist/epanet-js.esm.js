...
function () {
  ...
  Workspace.prototype.getError = function (code) {
    var title1Ptr = this._instance._malloc(1);
...
function () {
  ...
  ProjectFunctions.prototype.getTitle = function () {
    ...
    var memory = this._allocateMemory('char', 'char', 'char');
...
function () {
  ...
  TimePatternFunctions.prototype.getPatternLenth = function (index) {
    var _a;
...
function () {
  function Project(ws) {
    ...
    this.getPatternLenth = TimePatternFunctions.prototype.getPatternLenth;
  ...
  Project.prototype._allocateMemory = function (v1) {
    ...
    return types.reduce(function (acc, t) {
      var memsize = t === 'char' ? 1 : t === 'int' ? 4 : 8;
  ...
  Project.prototype._allocateMemoryForArray = function (arr) {
    ...
    var dataHeap = new Uint8Array(this._instance.HEAPU8.buffer, dataPtr, nDataBytes);
    dataHeap.set(new Uint8Array(data.buffer)); //return dataHeap.byteOffset?
...
(function (LinkResultTypes) {
  ...
  LinkResultTypes[LinkResultTypes["Velcoity"] = 1] = "Velcoity";
...
function readBinary(results) {
  ...
  var offsetResults = 884 + 36 * prolog.nodeCount + 52 * prolog.linkCount + 8 * prolog.resAndTankCount + 28 * prolog.pumpCount + 4;
...
var getNodeResults = function getNodeResults(prolog, offsetResults, nodeIndex, dataView) {
  var nodeResults = {
    demand: [],
    head: [],
    pressure: [],
...
var getLinkResults = function getLinkResults(prolog, offsetResults, linkIndex, dataView) {
  var linkResults = {
    flow: [],
    velcoity: [],
    headloss: [],
  ...
  var result = ['flow', 'velcoity', 'headloss', 'avgWaterQuality', 'status', 'setting', 'reactionRate', 'friction'].reduce(function (map, obj, i) {
    var _a;
...
export { ActionCodeType$1 as ActionCodeType, AnalysisStatistic$1 as AnalysisStatistic, ControlType$1 as ControlType, CountType$1 as CountType, CurveType$1 as CurveType, DemandModel$1 as DemandModel, FlowUnits$1 as FlowUnits, HeadLossType$1 as HeadLossType, InitHydOption$1 as InitHydOption, LinkProperty$1 as LinkProperty, LinkStatusType$1 as LinkStatusType, LinkType$1 as LinkType, MixingModel$1 as MixingModel, NodeProperty$1 as NodeProperty, NodeType$1 as NodeType, ObjectType$1 as ObjectType, Option$1 as Option, Project, PumpStateType$1 as PumpStateType, PumpType$1 as PumpType, QualityType$1 as QualityType, RuleObject$1 as RuleObject, RuleOperator$1 as RuleOperator, RuleStatus$1 as RuleStatus, RuleVariable$1 as RuleVariable, SizeLimits$1 as SizeLimits, SourceType$1 as SourceType, StatisticType$1 as StatisticType, StatusReport$1 as StatusReport, TimeParameter$1 as TimeParameter, Workspace, readBinary };
//# sourceMappingURL=epanet-js.esm.js.map
